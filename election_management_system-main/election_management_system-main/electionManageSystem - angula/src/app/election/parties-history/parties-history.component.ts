...
import {getCandidatesByParty} from 'src/app/model/candidate/candidate';
...
@Component({
  ...
  styleUrls: ['./parties-history.component.css']
})
export class PartiesHistoryComponent implements OnInit {
  ...
  constructor(private eleCon: ElectionController, private _candidateservice: CandidateService, private route: ActivatedRoute, private _partieService: PartieService, private _voteService: VoteService) {
  }
